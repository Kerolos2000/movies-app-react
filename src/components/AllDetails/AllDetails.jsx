...
export default function AllDetails() {
  ...
  const {
    ...
    `https://api.themoviedb.org/3/all/${pramsId}?api_key=a51a2678a6ebc32710f900cff1862764&language=en-US`
  );
  ...
  const {
    ...
    `https://api.themoviedb.org/3/all/${pramsId}/similar?api_key=a51a2678a6ebc32710f900cff1862764&language=en-US&page=1`
  );
      ...
      {loader1 || loader2 ? (
        ...
        <>
          ...
          <Details
            ...
            release_date={
              details1.release_date
                ? `release date : ${details1.release_date}`
                : null
            }
