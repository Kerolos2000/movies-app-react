...
//     error: error1,
//   } = useAxios(
//     `https://api.themoviedb.org/3/movie/${prams.id}?api_key=a51a2678a6ebc32710f900cff1862764&language=en-US`
//   );
//   let {
//     details: details2,
//     loader: loader2,
//     error: error2,
//   } = useAxios(
//     `https://api.themoviedb.org/3/movie/${prams.id}/similar?api_key=a51a2678a6ebc32710f900cff1862764&language=en-US&page=1`
//   );
...
//   release_date={`release date : ${details1.release_date}`}
